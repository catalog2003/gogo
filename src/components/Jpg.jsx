...
const wordToReplace = "Jpg"; // Change this word to replace "image" everywhere
...
const features = [
  ...
  { icon: FaUpload, title: "Batch Processing", description: `Convert multiple ${wordToReplace} at once for efficiency.` },
...
const faqs = [
  ...
  { question: `Can I convert multiple ${wordToReplace} at once?`, answer: `Yes, our batch processing feature allows you to upload multiple ${wordToReplace}.` },
  { question: `Does it work with scanned ${wordToReplace}?`, answer: "Yes, you can extract text from scanned documents, invoices, and forms." },
  { question: "Is my data safe?", answer: `Yes, we don’t store or share your ${wordToReplace} or extracted text.` },
  { question: "Can I use this on mobile?", answer: "Yes! Our tool is optimized for both desktop and mobile devices." },
  { question: `Does it work with blurry ${wordToReplace}?`, answer: `Our AI-powered OCR can extract text even from low-resolution ${wordToReplace}.` },
