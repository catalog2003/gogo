...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-white bg-opacity-80 backdrop-blur-lg shadow-lg">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex justify-between items-center py-4">
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 hover:bg-gray-300 transition"
          >
